/*! For license information please see d6299ec518d2f6c88ffe53f9b15b4a9a0188ded4-2523809ecca5e2c50fec.js.LICENSE.txt */
"use strict";
        ...
        47290: function(e, t, n) {
            ...
            var r, o = n(96540),
                ...
                c = (e, t) => {
                    ...
                    if (null != e && s)
                        for (var r of s(e)) t.indexOf(r) < 0 && a.call(e, r) && (n[r] = e[r]);
                    return n
                };
            (e => {
                const t = class {
                    ...
                    static encodeSegments(e, n, o = 1, s = 40, a = -1, u = !0) {
                        ...
                        let h, c;
                        for (h = o;; h++) {
                            const r = 8 * t.getNumDataCodewords(h, n),
                                o = l.getTotalBits(e, h);
                            if (o <= r) {
                                c = o;
                                break
                            }
                        ...
                        for (const r of [t.Ecc.MEDIUM, t.Ecc.QUARTILE, t.Ecc.HIGH]) u && c <= 8 * t.getNumDataCodewords(h, r) && (n = r);
                        let d = [];
                        for (const t of e) {
                            r(t.mode.modeBits, 4, d), r(t.numChars, t.mode.numCharCountBits(h), d);
                            for (const e of t.getData()) d.push(e)
                        }
                        i(d.length == c);
                        const f = 8 * t.getNumDataCodewords(h, n);
                        ...
                        return d.forEach(((e, t) => g[t >>> 3] |= e << 7 - (7 & t))), new t(h, n, g, a)
                    }
                    getModule(e, t) {
                    ...
                    drawFormatBits(e) {
                        ...
                        i(r >>> 15 == 0);
                        for (let i = 0; i <= 5; i++) this.setFunctionModule(8, i, o(r, i));
                        this.setFunctionModule(8, 7, o(r, 6)), this.setFunctionModule(8, 8, o(r, 7)), this.setFunctionModule(7, 8, o(r, 8));
                        for (let i = 9; i < 15; i++) this.setFunctionModule(14 - i, 8, o(r, i));
                        for (let i = 0; i < 8; i++) this.setFunctionModule(this.size - 1 - i, 8, o(r, i));
                        for (let i = 8; i < 15; i++) this.setFunctionModule(8, this.size - 15 + i, o(r, i));
                    ...
                    drawVersion() {
                        ...
                        for (let n = 0; n < 18; n++) {
                            const e = o(t, n),
                                r = this.size - 11 + n % 3,
                                i = Math.floor(n / 3);
                            this.setFunctionModule(r, i, e), this.setFunctionModule(i, r, e)
                        }
                    }
                    ...
                    addEccAndInterleave(e) {
                        ...
                        const o = t.NUM_ERROR_CORRECTION_BLOCKS[r.ordinal][n],
                            ...
                            u = Math.floor(l / o);
                        let h = [];
                        const c = t.reedSolomonComputeDivisor(s);
                        for (let i = 0, f = 0; i < o; i++) {
                            let n = e.slice(f, f + u - s + (i < a ? 0 : 1));
                            f += n.length;
                            const r = t.reedSolomonComputeRemainder(n, c);
                            i < a && n.push(0), h.push(n.concat(r))
                        }
                        let d = [];
                        for (let t = 0; t < h[0].length; t++) h.forEach(((e, n) => {
                            (t != u - s || n >= a) && d.push(e[t])
                        }));
                    ...
                    getPenaltyScore() {
                        ...
                        for (let i = 0; i < this.size; i++) {
                            let n = !1,
                                r = 0,
                                o = [0, 0, 0, 0, 0, 0, 0];
                            for (let s = 0; s < this.size; s++) this.modules[i][s] == n ? (r++, 5 == r ? e += t.PENALTY_N1 : r > 5 && e++) : (this.finderPenaltyAddHistory(r, o), n || (e += this.finderPenaltyCountPatterns(o) * t.PENALTY_N3), n = this.modules[i][s], r = 1);
                        ...
                        for (let i = 0; i < this.size; i++) {
                            let n = !1,
                                r = 0,
                                o = [0, 0, 0, 0, 0, 0, 0];
                            for (let s = 0; s < this.size; s++) this.modules[s][i] == n ? (r++, 5 == r ? e += t.PENALTY_N1 : r > 5 && e++) : (this.finderPenaltyAddHistory(r, o), n || (e += this.finderPenaltyCountPatterns(o) * t.PENALTY_N3), n = this.modules[s][i], r = 1);
                            e += this.finderPenaltyTerminateAndCount(n, r, o) * t.PENALTY_N3
                        }
                        for (let i = 0; i < this.size - 1; i++)
                            for (let n = 0; n < this.size - 1; n++) {
                                const r = this.modules[i][n];
                                r == this.modules[i][n + 1] && r == this.modules[i + 1][n] && r == this.modules[i + 1][n + 1] && (e += t.PENALTY_N2)
                            }
                        let n = 0;
                        for (const t of this.modules) n = t.reduce(((e, t) => e + (t ? 1 : 0)), n);
            ...
            function N(e, t, n, r) {
                ...
                const o = n ? C : 0,
                    ...
                    a = (r.width || s) * l,
                    u = (r.height || s) * l,
                    h = null == r.x ? e.length / 2 - a / 2 : r.x * l,
            ...
            function P(e) {
                const t = e,
                    ...
                    P = c(t, ["value", "size", "level", "bgColor", "fgColor", "includeMargin", "style", "imageSettings"]),
                ...
                (0, o.useEffect)((() => {
                    if (null != _.current) {
                        const e = _.current,
                            t = e.getContext("2d");
                        if (!t) return;
                        let o = d.QrCode.encodeText(n, f[i]).getModules();
                        const u = a ? C : 0,
                            h = o.length + 2 * u,
                            c = N(o, r, a, R),
                            g = I.current,
                            m = null != c && null !== g && g.complete && 0 !== g.naturalHeight && 0 !== g.naturalWidth;
                        m && null != c.excavation && (o = A(o, c.excavation));
                        const E = window.devicePixelRatio || 1;
                        e.height = e.width = r * E;
                        const w = r / h * E;
                        t.scale(w, w), t.fillStyle = s, t.fillRect(0, 0, h, h), t.fillStyle = l, v ? t.fill(new Path2D(p(o, u))) : o.forEach((function(e, n) {
                            e.forEach((function(e, r) {
                                e && t.fillRect(r + u, n + u, 1, 1)
                            }))
                        })), m && t.drawImage(g, c.x + u, c.y + u, c.w, c.h)
                    }
                })), (0, o.useEffect)((() => {
                    O(!1)
                }), [y]);
                ...
                let z = null;
                return null != y && (z = o.createElement("img", {
                    src: y,
                    key: y,
                    style: {
                        display: "none"
                    ...
                    ref: I
                })), o.createElement(o.Fragment, null, o.createElement("canvas", h({
                    style: b,
                    height: r,
                    width: r,
                    ref: _
            ...
            function y(e) {
                const t = e,
                    ...
                    R = c(t, ["value", "size", "level", "bgColor", "fgColor", "includeMargin", "imageSettings"]);
                let v = d.QrCode.encodeText(n, f[i]).getModules();
                const P = a ? C : 0,
                    y = v.length + 2 * P,
                    _ = N(v, r, a, u);
                let I = null;
                null != u && null != _ && (null != _.excavation && (v = A(v, _.excavation)), I = o.createElement("image", {
                    xlinkHref: u.src,
                    height: _.h,
                    width: _.w,
                    x: _.x + P,
            ...
            var _ = e => {
                const t = e,
                    ...
                    r = c(t, ["renderAs"]);
                return "svg" === n ? o.createElement(y, h({}, r)) : o.createElement(P, h({}, r))
            }
        }
    }
]);