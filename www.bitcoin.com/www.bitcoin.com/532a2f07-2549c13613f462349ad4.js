            ...
            e.exports = function(e) {
                ...
                function L(e, n, t, r, o) {
                    ...
                    if ("function" == typeof s) return function(e, n, t, r) {
                        for (var o = e && e._component, i = o, M = e, a = o && e._componentConstructor === n.nodeName, u = a, s = T(n); o && !u && (o = o._parentComponent);) u = o.constructor === n.nodeName;
                        return o && u && (!r || o._component) ? (C(o, s, 3, t, r), e = o.base) : (i && !a && (U(i), e = M = null), o = b(n.nodeName, s, t), e && !o.nextBase && (o.nextBase = e, M = null), C(o, s, 1, t, r), e = o.base, M && e !== M && (M._component = null, h(M, !1))), e
                    }(e, n, t, r);
                    ...
                    return !I && N && 1 === N.length && "string" == typeof N[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != N[0] && (c.nodeValue = N[0]) : (N && N.length || null != c) && function(e, n, t, r, o) {
                            ...
                            if (0 !== T)
                                for (A = 0; A < T; A++) {
                                    var E;
                                    if (s = null, null != (E = (u = n[A]).key)) D && void 0 !== N[E] && (s = N[E], N[E] = void 0, D--);
                                    else if (g < z)
                                        for (i = g; i < z; i++)
                    ...
                    function(e) {
                        ...
                        var A = "undefined" != typeof Reflect && Reflect.ownKeys ? Reflect.ownKeys : Object.getOwnPropertySymbols ? function(e) {
                            ...
                            p = function() {
                                ...
                                return e.prototype.onBecomeObserved = function() {
                                    ...
                                    Ze(),
                                        function(e) {
                                            e.lowestObserverState !== K.STALE && (e.lowestObserverState = K.STALE, e.observers.forEach((function(n) {
                        ...
                        function ue(e, n, t) {
                            ...
                            return Ye.trackingDerivation = i,
                                function(e) {
                                    for (var n = e.observing, t = e.observing = e.newObserving, r = K.UP_TO_DATE, o = 0, i = e.unboundDepsCount, M = 0; M < i; M++) 0 === (a = t[M]).diffValue && (a.diffValue = 1, o !== M && (t[o] = a), o++), a.dependenciesState > r && (r = a.dependenciesState);
                                    for (t.length = o, e.newObserving = null, i = n.length; i--;) 0 === (a = n[i]).diffValue && Pe(a, e), a.diffValue = 0;
                                    for (; o--;) {
                                        var a;
                        ...
                        var xe = function(e) {
                                ...
                                return function(e, n) {
                                    ...
                                    this.value, (e = this.prepareNewValue(e)) !== Ye.UNCHANGED && this.setNewValue(e)
                            ...
                            he = function() {
                                ...
                                return e.prototype.onBecomeStale = function() {
                                    ! function(e) {
                                        e.lowestObserverState === K.UP_TO_DATE && (e.lowestObserverState = K.POSSIBLY_STALE, e.observers.forEach((function(n) {
                        ...
                        function We(e, n) {
                            if (console.log("[mobx.trace] '" + e.name + "' is invalidated due to a change in: '" + n.name + "'"), e.isTracing === $.BREAK) {
                                var t = [];
                                ! function e(n, t, r) {
                                    t.length >= 1e3 ? t.push("(and many more)") : (t.push("" + new Array(r).join("\t") + n.name), n.dependencies && n.dependencies.forEach((function(n) {
                                        return e(n, t, r + 1)
                                    })))
                                ...
                                try {
                                    for (var a = L(M), u = a.next(); !u.done; u = a.next()) {
                                        var s = u.value,
                                            ...
                                            l = (t && s in t ? t[s] : c.get ? ee : r)(e, s, c, !0);
                        ...
                        function Pn(e, n, t) {
                            if (2 !== arguments.length || wt(e))
                                if (mt(e)) {
                                    var r = e[d];
                                    r.values.get(n) ? r.write(n, t) : r.addObservableProp(n, t, r.defaultEnhancer)
                        ...
                        function et(e, n) {
                            var t, r = new Promise((function(r, o) {
                                var i = $n(e, r, x(x({}, n), {
                                    onError: o
                                }));
                                t = function() {
                            ...
                            return void 0 === t && (t = -1),
                                function e(n, t, r, o, i) {
                                    ...
                                    if (o.push(n), i.push(t), u) {
                                        ...
                                        for (; l--;)
                                            if (!Qt(t, D = N[l]) || !e(n[D], t[D], r - 1, o, i)) return !1
                                    }
                ...
                t.r(n),
                    function(e) {
                        ...
                        function f(e) {
                            ...
                            return A(e.prototype || e), e.isMobXReactObserver = !0, e
                        }
                        ...
                        d.displayName = "Observer", "undefined" != typeof window ? window : void 0 !== e || "undefined" != typeof self && self;
                        var p = function(e, n) {
                                return e(n = {
                                    exports: {}
                                }, n.exports), n.exports
                        ...
                        return this.map((function(n) {
                            var t = function(e, n) {
                                ...
                                if (n && "function" == typeof btoa) {
                                    var a = (t = M, r = btoa(unescape(encodeURIComponent(JSON.stringify(t)))), o = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(r), "/*# ".concat(o, " */")),
                                        u = M.sources.map((function(e) {
                    ...
                    A = {
                        ...
                        init: function(e) {
                            ! function() {
                                ...
                                }, p(w, x), w.src = "about:blank", (e.container ? document.querySelector(e.container) : document.body).appendChild(w), d && (w.setAttribute("style", d), d = null)
                            }(e)
                        },
                ...
                var c = /^http:\/\//,
                    l = function() {
                        ...
                        return n = e, (t = [{
                            ...
                            value: function(e) {
                                var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                                return this._setRememberHeaders(n), new M.default(this.api, e, this.audience).getUserData().then((function(e) {
                ...
                var c = function(e) {
                    ...
                    function s(e) {
                        ...
                        return function(e, n) {
                            ...
                            e.preventDefault();
                            var t, r, o = (r = "/.netlify/identity", -1 === (t = n.state.url).indexOf(r) ? t : t.substring(0, t.length - r.length));
                            n.props.onSiteURL(o)
